...
namespace Cardos_Dan_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Cardos_Dan_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Cardos_Dan_Lab8Context context,
